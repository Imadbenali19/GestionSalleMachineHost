...
<!-- Page level plugins -->
<%-- <script src="<%= request.getContextPath() %>/template/vendor/chart.js/Chart.min.js"></script> --%>

<!-- Page level custom scripts -->
<%-- <script src="<%= request.getContextPath() %>/template/js/demo/chart-bar-demo.js"></script> --%>
<%-- <script src="<%= request.getContextPath() %>/template/js/demo/chart-pie-demo.js"></script> --%>
